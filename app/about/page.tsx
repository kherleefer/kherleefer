      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-14">
        ...
        <section>
          <AboutContent
            ...
            description="A passionate adolescent software engineer obsessed with blockchain, open source, and building cool stuff for the future, I love learning, sharing, and collaborating with other devs. I believe tech should be fun, creative, and make the world better for everyone!, More fun when we play chess and get to know more about ourselves"
