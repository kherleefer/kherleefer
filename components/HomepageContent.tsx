  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 ">
      {projects.map((p, idx) => (
        <motion.div
          key={idx}
          className="interactive-line border-t py-5 rounded-md"
  ...
  return (
    <div className="flex flex-wrap gap-2 rounded-md">
      {skills.map((skill) => (
        <span
          key={skill}
          className="soft-surface line border px-4 py-2 text-sm font-semibold"
        >
          {skill}
        </span>
      ))}
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {remarks.map((r, idx) => (
        <motion.div
          key={idx}
          className="interactive-line border-l-2 p-4 rounded-md"
