...
export default function CourseAiChat({ course }: { course: Course }) {
  ...
  return (
    <section
      className="surface interactive-line mt-14 border p-6 sm:p-8"
    ...
    >
      ...
      <div className="soft-surface mt-5 max-h-[420px] space-y-4 overflow-y-auto border p-4">
        {messages.map((message, index) => (
          ...
          >
            <div
              className={`inline-block max-w-[85%] border px-4 py-3 text-sm leading-6 ${
                message.role === "user"
      ...
      {error && <p className="mt-4 text-sm font-semibold" role="alert">{error}</p>}
